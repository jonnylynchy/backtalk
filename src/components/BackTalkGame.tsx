		...
		<div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 p-4">
			<div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-md">
				...
				<div className="d-flex flex-column">
					<Button
						onClick={() =>
							playRecording("/audio/hello-how-are-you.wav")
						}
						className="mb-3 w-100 btn btn-primary"
					>
						<Volume2 size={24} />
					...
					<Button
						...
						className={`mb-3 w-100 flex-fill btn btn-primary`}
						action={gameState.isRecording ? "danger" : "primary"}
					>
						<Mic size={24} />
						<span>
							{gameState.isRecording ? "Stop Recording" : "Start Recording"}
						</span>
					</Button>
